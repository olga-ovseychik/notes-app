...
const  Register = () => {
    ...
    }, [userInfo, errors, finishSubmit, navigate, submitting]);
    ...
    const validateValues = (inputValues) => {
        ...
        if (inputValues.firstName == null || inputValues.firstName < 1) {
            errors.firstName = "This field is required.";
        }
        if (inputValues.lastName == null || inputValues.lastName < 1) {
    ...
    return(
        <div className="grid grid-cols-12">
            ...
            <form 
                ...
                className="lg:col-span-4 xs:col-span-12 h-dvh lg:px-12 md:px-52 sm:px-40 xs:px-12 py-36 lg:py-28 xs:py-20 rounded-md flex flex-col justify-center gap-4 bg-slate-50 border border-semiLight shadow-xl dark:bg-bgColor dark:border-none overflow-auto scroll-smooth">
                ...
                <label>
                    ...
                    {errors.password ? (<div className='text-red-400 p-2 mt-2 italic whitespace-pre-line'>{`${errors.password}`}</div>) : null}
                </label>
                <label>
                ...
                <p className="text-textColor dark:text-semiLight">Do you already have an account?
