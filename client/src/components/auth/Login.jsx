        ...
        <div className="grid grid-cols-12">
            ...
            <div className={`col-span-8 xs:hidden lg:flex bg-bgLogin bg-cover`}>
                <div className="backdrop-blur-md bg-white/2 w-full flex flex-col justify-center items-center p-16 relative">
                    ...
                    <div className="backdrop-blur-md bg-black/10 w-full h-10 py-2 absolute bottom-0">
                    <div className="flex flex-col items-center justify-center">
                        <a className="flex text-xs text-white" href="https://www.freepik.com/free-photo/hand-writing-notebook-close-up_14411988.htm#fromView=search&page=1&position=8&uuid=543fdaf8-fe20-4f4a-8447-6e6912b93f11">illustrations by freepik</a>
                        <a className="flex text-xs text-white" href="https://icons8.com/">Icons by Icons8</a>
                    </div>
                    </div>
                </div>
            </div>
