...
const SideNav = () => { 
    ...
    return (
        <>
            <nav id="sideNav"
                 className="h-dvh xs:h-full lg:col-span-2 sm:col-span-1 xs:col-span-2 bg-bgColor overflow-hidden origin-left dark:bg-darkModeSecColor dark:border-none dark:shadow-darkMode">
