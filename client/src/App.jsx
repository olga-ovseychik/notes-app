		...
		<div className="grid grid-cols-12">
			...
			<main className='grid lg:col-span-10 sm:col-span-11 xs:col-span-10'>
				<div className='grid xs:grid-cols-12 xs:grid-rows-2 sm:grid-rows-1'>
					<div className={`grid ${location.pathname=='/profile' ? 'xs:row-span-12 sm:col-span-0' : 'xs:row-span-1 sm:col-span-4'} xs:col-span-full xs:h-full`}>
						{token && location.pathname !== `/profile` ? <ItemsList /> : null}
					</div>
					<div className={`grid xs:row-span-1 xs:col-span-full ${location.pathname=='/profile' ? 'col-span-10' : 'sm:col-span-8'} xs:h-full`}>
						<Outlet />                 
					</div>
				</div>
			</main>
